...
def main():
    ...
    parser.add_argument('--pretraining_epoch', type=int, default=1, help='The epoch of pre-training phase')
    parser.add_argument('--MaxIter', type=int, default=1, help='The epoch of fine-tuning phase')
